...
function TeamSelection() {
    ...
    async function getRegisteredTeams() {
        try {
            const response = await axios.get('http://87.223.128.77:5000/api/admin/getTeams2');
    ...
    async function startGame() {
        try {
            ...
            const respuestaPost = await axios.post('http://87.223.128.77:5000/api/admin/saveSelectedTeams', selectedTeamsTemp);
            ...
            const respuestaGet = await axios.get('http://87.223.128.77:5000/api/admin/startGame');
    ...
    async function recoverTeams() {
        try {
            ...
            const response = await axios.get('http://87.223.128.77:5000/api/admin/loadTeams'); //Cambiar la dirección IP por la de la máquina que corre el backend
            console.log(response.data);
            setRegisteredTeams(response.data);
    ...
    return (
        <div className="App min-h-screen 2xl:h-screen bg-gray-100 flex flex-col">
            <Header/>
            <div className=" flex 2xl:flex-col sm:flex-col items-center justify-center 2xl:h-[50rem] 2xl:mt-40 lg:mt-[13rem] xl:mt-[9rem] md:mt-[5rem] sm:mt-20 md:h-[30rem] 2xl:pt-20"  >
