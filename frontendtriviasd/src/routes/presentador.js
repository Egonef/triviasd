...
export default function Presentador(){
    ...
    async function getTimeLeft() {
        try {
            const response = await axios.get('http://87.223.128.77:5000/api/caster/getTimeLeft');
    ...
    async function sendTimeLeft(newTimeLeft) {
        try {
            const response = await axios.post('http://87.223.128.77:5000/api/caster/saveTimeLeft', {
    ...
    async function getTeams() {
        try {
            ...
            const response = await axios.get('http://87.223.128.77:5000/api/admin/getSelectedTeams'); //Cambiar la dirección IP por la de la máquina que corre el backend
    ...
    async function checkgameready() {
        try {
            if (gameState === false) {
                const response = await axios.get('http://87.223.128.77:5000/api/admin/getGameStatus'); //Cambiar la dirección IP por la de la máquina que corre el backend
    ...
    async function nextTurn() {
        try {
            const response = await axios.post('http://87.223.128.77:5000/api/caster/nextTurn', {
                registeredTeams
    ...
    async function updateTeams() {
        ...
        try {
            const response = await axios.put('http://87.223.128.77:5000/api/admin/saveSelectedTeams2', registeredTeams); // Envía el array directamente
            console.log(response.data);
        } catch (error) {
            console.error("Error al llamar a la API:", error.response ? error.response.data : error.message);
        }
    ...
    async function sendLastAnswerTeam(teamName) {
        try {
            const response = await axios.post('http://87.223.128.77:5000/api/admin/setLastAnswerTeam', {
                teamName
            });
            console.log(response.data);
        } catch (error) {
    ...
    async function searchQuestion() {
        try {
            if (tema !== '' && dificultad !== '') {
                const response = await axios.post('http://87.223.128.77:5000/api/caster/setTopicandDifficulty', {
                    tema,
                    dificultad
                });
    ...
    async function saveTeams2() {
        try {
            const response = await axios.post('http://87.223.128.77:5000/api/admin/saveTeams2', registeredTeams); // Enviar el array directamente
